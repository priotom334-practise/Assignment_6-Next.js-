...
A modern and responsive workout discovery and planning web application built with Next.js, TypeScript, and Tailwind CSS. FITLOG allows users to explore exercises, view detailed workout information, build a daily workout plan, and save exercises for later.

# 📌 About the Project

FITLOG is designed to provide a simple and user-friendly experience for discovering and organizing workouts.

The application fetches workout data from a REST API and allows users to manage their selected exercises directly in the browser using localStorage.

The project focuses on demonstrating modern frontend development concepts such as Next.js App Router, dynamic routing, React state management, API integration, responsive design, and client-side data persistence.
